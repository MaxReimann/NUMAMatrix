...
void strassen_multiply(int n, matrix a, matrix b, matrix c, matrix d)
{
	if (n <= BREAK) {
		...
		sub(n, a12, a22, d11);
		add(n, b21, b22, d12);
		strassen_multiply(n, d11, d12, c11, d21);
		sub(n, a21, a11, d11);
		add(n, b11, b12, d12);
		strassen_multiply(n, d11, d12, c22, d21);
		add(n, a11, a12, d11);
		strassen_multiply(n, d11, b22, c12, d12);
		sub(n, c11, c12, c11);
		sub(n, b21, b11, d11);
		strassen_multiply(n, a22, d11, c21, d12);
		add(n, c21, c11, c11);
		sub(n, b12, b22, d11);
		strassen_multiply(n, a11, d11, d12, d21);
		add(n, d12, c12, c12);
		add(n, d12, c22, c22);
		add(n, a21, a22, d11);
		strassen_multiply(n, d11, b11, d12, d21);
		add(n, d12, c21, c21);
		sub(n, c22, d12, c22);
		add(n, a11, a22, d11);
		add(n, b11, b22, d12);
		strassen_multiply(n, d11, d12, d21, d22);
		add(n, d21, c11, c11);
		add(n, d21, c22, c22);
	}
}
